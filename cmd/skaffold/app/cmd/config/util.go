...
// ResolveKubectlContext sets up the actual kube-context to be used. The order of precedence is
// 1) command line
// 2) skaffold.yml
...
// GetKubeContextAfterInitilization returns the kube-context to be used. The context must be properly
// initilized by ResolveKubectlContext before calling this function.
func GetKubeContextAfterInitilization() string {
	return kubecontext
}
